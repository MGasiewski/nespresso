...
public class OpcodeLookup {
	public static final Set<Integer> oneByteOpcodes = new HashSet<>(List.of(
			...
			0xAA, 0x8A, 0xCA, 0xE8, 0xA8, 0x98, 0x88, 0xC8, 0xF8, // Register Instructions
			0x2A, // ROL
			0x6A, // ROR
			0x40, // RTI
			0x60, // RTS
	...
	public static final Set<Integer> twoByteOpcodes = new HashSet<>(List.of(
			...
			0x06, 0x16, // ASL
			0x24, // BIT
			0x10, 0x30, 0x50, 0x70, 0x90, 0xB0, 0xD0, 0xF0, // Branch Instruction
			...
			0x26, 0x36, // ROL
			0x66, 0x76, // ROR
			0xE9, 0xE5, 0xF5, 0xE1, 0xF1, 0xEB, // SBC
			0x85, 0x95, 0x81, 0x91, // STA
			0x86, 0x96, // STX
			0x84, 0x94, // STY
			0x80, 0x82, 0x89, 0xC2, 0xE2, //NOP
			0xB,  0x2B, //ANC
			0x4B, //ALR
			0x6B, //ARR
			0xAB, //LAX
